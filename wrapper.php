...
?>
	...
	function posting($user_access_token, $id, $msg, $localevento, $dataevento, $horainicio, $horafinal, $descricao, $img_url, $post_as)
	{
		...
		$data["message"] = 'Nome do evento: ' . $msg .
		 ', Local do evento: ' . $localevento . ', Data do evento: ' . $dataevento . ', Começa às : ' . $horainicio . ', Termina às: ' . $horafinal . '.                                 /n' . $descricao ;
	...
	$access_token	= "EAAMKJSSfxQwBABtWkzrXkN7ucLSEESZArbb3FL2QpQL3PVJy2wU22TFTIc1pvCM9hOCmz82ieeGV5Bbfx4hjFPoTMLHJWvJOZCJfjYCgD6pP5oSQ03orlZCpCo0tZBWGW5m0o9BjBLlxfS1mraqdEdXTpBDTl2ZCx2hznMK4aPkv47WPLfddBZAPZC4AkhZCMZAFcmpBObfibAQZDZD";
